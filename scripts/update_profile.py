...
def render_signal(release: str, release_state: str, deploy_label: str, deploy_state: str,
    ...
    parts = [
        ...
        "<style>.bg{fill:#03070b}.line{stroke:#15324a}.soft{stroke:#0d2639}.label{fill:#f6b72e;font:700 17px 'Playfair Display','EB Garamond',Georgia,'Times New Roman',serif;letter-spacing:.5px}.value{fill:#f7fbfc;font:700 21px 'EB Garamond',Georgia,'Times New Roman',serif}.state{fill:#0de3f4;font:700 17px 'Playfair Display','EB Garamond',Georgia,'Times New Roman',serif;letter-spacing:.5px}.state-muted{fill:#b7d5df;font:16px 'EB Garamond',Georgia,'Times New Roman',serif;letter-spacing:.3px}.meta{fill:#8bdbe9;font:16px 'EB Garamond',Georgia,'Times New Roman',serif;letter-spacing:.8px}.foot{fill:#86adbd;font:14px 'EB Garamond',Georgia,'Times New Roman',serif;letter-spacing:.2px}</style>",
